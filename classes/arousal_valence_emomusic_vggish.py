...
class ArousalValenceEmomusicVggishClassifier:
    """
    Classifies the arousal and valence of an audio file using VGGish embeddings.
    """
    ...
    def __init__(self):
        ...
        - emomusic-audioset-vggish-2.pb (classification model)
        """
        # Paths to the models
        self.embedding_model_path = os.path.join(MODELS, "audioset-vggish-3.pb")
        self.classification_model_path = os.path.join(MODELS, "emomusic-audioset-vggish-2.pb")
