...
class MoodAggressiveClassifier:
    """
    Classifies the mood of an audio file into `aggressive` or `non_aggressive`.
    """
    ...
    def __init__(self):
        ...
        - mood_aggressive-audioset-vggish-1.pb (classification model)
        """
        # Paths to the models
        self.embedding_model_path = os.path.join(MODELS, "audioset-vggish-3.pb")
        self.classification_model_path = os.path.join(MODELS, "mood_aggressive-audioset-vggish-1.pb")
    ...
    def classify_mood(self, audio_file):
        ...
        Returns:
            dict: A dictionary with mood classes (`aggressive`, `non_aggressive`) and their probabilities.
        """
