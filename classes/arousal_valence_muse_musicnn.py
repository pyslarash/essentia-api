...
class ArousalValenceMuseMusiCNNClassifier:
    """
    Classifies the arousal and valence of an audio file using Muse MusiCNN embeddings.
    """
    ...
    def __init__(self):
        ...
        - muse-msd-musicnn-2.pb (classification model)
        """
        # Paths to the models
        self.embedding_model_path = os.path.join(MODELS, "msd-musicnn-1.pb")
        self.classification_model_path = os.path.join(MODELS, "muse-msd-musicnn-2.pb")
